...
public class Server implements Comparable<Server> {
	private String ip;
	private String name;
	private EPlatform os = EPlatform.Linux;//默认是centos系统，window用于开发调试用
	...
	/*
	 * public ServerCommon findServerCommon() { ServerCommon serverCommon =
	 * ZkClient.getInst().getDateObj(ZkPath.servers.getRoot(), ServerCommon.class);
	 * return serverCommon; }
	 */
